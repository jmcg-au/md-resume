...
## Volunteer at State Library of New South Wales (June 2017 – December 2017)

- Re-housing collection items (photographic negatives), adhering to
  strict handling procedures to maintain archival integrity.
- Performing large-scale data entry to transfer catalogue records from
  index cards to a modern library database.
- Supervising art & craft activities for children during school
  holiday programs.

## Mechanist at Lyric Theatre, Sydney (December 2016 – January 2017)

- Unloading, assembly, disassembly, and loading of stage scenery and
  equipment at the beginning & end of a production.
- Following direction from Head Mechanist & venue supervisor regarding
  timing & order of construction/dismantling of scenic elements.
- Basic use of hand & power tools.
- Practicing safe lifting & carrying techniques, often involving
  multiple people transporting heavy & cumbersome objects.
...
- Providing consistent friendly service to customers.
- Responsible handling of cash.
- Multi-tasking in a fast-paced & demanding work environment.

## Crew member at Salvos Store, Kings Park, Adelaide (June – July 2014)

- Evaluating, sorting, tagging, and displaying donated items.
- Maintaining neat & tidy presentation of products in the store.
- Receiving deliveries of furniture, large appliances, etc.
- Assisting customers in the store with any enquiries.
...
- Cooking and preparing meals as per company standards and customer
  requests.
...
- Stage lift maintenance at Sydney Conservatorium of Music.
- Fire curtain maintenance at Illawarra Performing Arts Centre.
- Construction of stage extension at Theatre Royal, Sydney.
- Loading & unloading stage scenery & equipment for Bell Shakespeare
  Company.
...
https://github.com/jmcg-au/md-resume/raw/refs/heads/manual-labour/resume.md
